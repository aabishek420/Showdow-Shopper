...
const ProductCard: React.FC<ProductCardProps> = ({ product }) => {
  ...
  return (
    <div
      className="bg-base-100 p-2 rounded-lg shadow-md flex flex-col items-center justify-center gap-2 hover:scale-103 cursor-pointer transition-transform relative"
    ...
    >
      ...
      {/* Product Title */}
      <h2 className="text-sm truncate w-50 text-center font-bold">
        {product.title}
      </h2>
